...
Will open source survive? Of course it will. The world isn't that black and white, and there's too much institutional weight behind it for it to just disappear. But will it be as ubiquitous? I'm not so sure. And if it does stay ubiquitous, I wonder if that just means people lower their standards for what they put out there. Skip the docs, skip the tests, ship it rough because the 100x overhead isn't worth it for a polished release.

I don't really like either of those options. Less open source, or worse open source. Both feel like a step backwards from the thing that made software good in the first place.
